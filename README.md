...
* [ ] Will complete previous features before more are planned

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='SimpleTwitterBetter.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />

GIF created with [Kap](https://getkap.co/).

## Notes

Using a different API like Twitter's was quite difficult at first. With little experience handling JSON objects and arrays, it was a difficult task. 
